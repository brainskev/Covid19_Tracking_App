...
**[Covid-19 Tracking App]** A mobile web application that collects information from an API to provide comprehensive data for the novel coronavirus for all the countries in the world. Real live data is obtained from the POSTMAN COVID19 API
...
- **[Provide comprehensive data for the novel coronavirus for all the countries in the world]**
- **[Provide real live data from the POSTMAN COVID19 API]**
...
Feel free to check the [issues page](https://github.com/brainskev/Covid19_Tracking_App/issues/).
